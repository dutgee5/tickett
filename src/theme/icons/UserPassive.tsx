...
function UserPassive(props:SvgIconProps) {
  return (
    <Svg
      width={props.size || 30}
    ...
    >
      ...
      <G mask="url(#a)">
        <Path fill="#373A42" d="M-40 -38H56V58H-40z" />
      </G>
    </Svg>
  )
}

export default UserPassive;